...
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* Add random heart positions and sizes */
      .hearts-container .heart:nth-child(odd) {
        left: 10%;
        animation-duration: 6s;
      }
      .hearts-container .heart:nth-child(even) {
        left: 70%;
      ...
      .hearts-container .heart {
          ...
          background-color: #ff69b4;
          transform: rotate(45deg);
          animation: heartFall linear; /* Gunakan animasi jatuh */
          opacity: 0.7;
      }
  ...
  <body>
    ...
    <script>
      function countdown() {
        const anniversaryDate = new Date("Oct 23, 2024 01:15:00").getTime();
        ...
        // Show hearts animation if the date is October 31
        if (now >= anniversaryDate) {
          showHearts();
        }
      }

      // Function to create and show falling hearts
      function showHearts() {
          const heartsContainer = document.getElementById("hearts-container");

          // Buat 50 hati untuk hujan hati
          for (let i = 0; i < 50; i++) {
              const heart = document.createElement("div");
              heart.classList.add("heart");

              // Atur posisi horizontal acak untuk setiap hati
              heart.style.left = Math.random() * 100 + 'vw';
              heart.style.animationDuration = Math.random() * 3 + 2 + 's'; // Durasi acak antara 2-5 detik
              ...
              setTimeout(() => {
                  heart.remove();
              }, 5000); // Hati akan dihapus setelah 5 detik
          }

          // Setelah 30 detik, hentikan hujan hati
          setTimeout(() => {
              heartsContainer.innerHTML = ''; // Hapus semua hati
          }, 30000); // Hentikan hujan hati setelah 30 detik
      }
